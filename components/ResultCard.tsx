...
export function ResultCard({ result }: { result: TriageResult }) {
  if (!result.can_assess || result.category === null) {
    return (
      <div className="flex flex-col gap-3 rounded-xl border-2 border-dashed border-zinc-400 bg-zinc-50 p-5 dark:border-zinc-600 dark:bg-zinc-900">
  ...
  return (
    <div className={`flex flex-col gap-3 rounded-xl border-2 p-5 ${style.bg} ${style.border}`}>
