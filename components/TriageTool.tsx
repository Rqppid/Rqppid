  ...
  return (
    <main className="mx-auto flex w-full max-w-5xl flex-1 flex-col gap-7 px-5 py-12 sm:py-16">
      <header className="max-w-2xl">
        ...
        <h1 className="mt-3 text-4xl font-medium tracking-[-.06em] text-white sm:text-5xl">
          Report a road defect.
        </h1>
        <p className="mt-4 max-w-xl text-base leading-7 text-zinc-400">
          Add a clear photo and a little context. HotPots will suggest a priority
          category for human review.
        </p>
      </header>
      ...
      <section className="grid gap-5 lg:grid-cols-[1fr_.6fr]">
        <div className="flex flex-col gap-5 rounded-3xl border border-white/10 bg-[#0d1918] p-5 shadow-2xl shadow-black/20 sm:p-7">
          ...
          <button
            ...
            className="flex items-center justify-center gap-2 rounded-xl bg-lime-300 px-4 py-3.5 font-semibold text-[#071014] transition-all hover:bg-lime-200 disabled:cursor-not-allowed disabled:bg-white/10 disabled:text-zinc-500"
          >
            {isLoading ? (
              <>
                <Spinner />
        ...
        <aside className="rounded-3xl border border-white/10 bg-[#0a1214] p-6">
          ...
          <ol className="mt-8 space-y-6">
            <li>
              ...
              <h2 className="mt-1 font-medium text-white">Get close to the defect</h2>
              <p className="mt-1 text-sm leading-6 text-zinc-500">
                Include its edges and enough road surface to show scale.
              </p>
            </li>
            <li>
              <span className="text-zinc-600">02</span>
              <h2 className="mt-1 font-medium text-white">Add the location</h2>
              <p className="mt-1 text-sm leading-6 text-zinc-500">
                A road name or nearby landmark helps the report reach the right
                place.
              </p>
            </li>
            <li>
              <span className="text-zinc-600">03</span>
              <h2 className="mt-1 font-medium text-white">Keep people in the loop</h2>
              <p className="mt-1 text-sm leading-6 text-zinc-500">
                Every suggestion is reviewed before action is taken.
              </p>
            </li>
          </ol>
        </aside>
